...
class UPat(MathTrait):
  ...
  @staticmethod
  def load(*src:UPat, dtype:Optional[DType]=None, name=None): return UPat(UOps.LOAD, dtype, src, name=name)
  @staticmethod
  def store(*src:UPat, name=None): return UPat(UOps.STORE, dtypes.void, src, name=name)
